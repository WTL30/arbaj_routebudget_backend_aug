...
//         console.log("📨 Sent ACK for protocol 1");
//       }
...
//         socket.write(Buffer.from(ack, "hex"));
//         console.log("📨 Sent ACK for protocol 13");
//       }
...
//         // console.log("✅ Real-time GPS stored:", saved.id);
//       }
...
//         console.log("📍 Longitude:", lon);
//         console.log("🚗 Speed (km/h):", speed);
//         console.log("🔢 GPS Serial Number:", serialNumber);
...
//         console.log(`📍 GPS from ${deviceIMEI}: ${lat}, ${lon}`);
...
//           // });
//           // console.log("✅ Real-time GPS stored:", saved.id, `(${lat.toFixed(6)}, ${lon.toFixed(6)})`);
//         } else {
